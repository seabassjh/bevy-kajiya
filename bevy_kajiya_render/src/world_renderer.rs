...
use crate::{
    ...
    mesh::{MeshTransform, RenderInstances},
    render_instances::{LoadedMeshesMap, RenderInstancesMap, RenderMesh, WRInstance},
...
pub fn setup_world_renderer(mut commands: Commands, render_context: Res<RenderContext>) {
